...
class SelectFragment6() : Fragment(), ActionMode.Callback {
    ...
    override fun onCreateView(
        ...
        itemSelection = context?.getSharedPreferences("Situation6", MODE_PRIVATE)
                ...
                object : SelectionTracker.SelectionObserver<Long>() {
                    override fun onSelectionChanged() {
                        ...
                        tracker?.let {
                            ...
                            if (actionMode == null) actionMode = (activity as AppCompatActivity?)!!.startSupportActionMode(this@SelectFragment6)
