...
class SelectFragment4() : Fragment(), ActionMode.Callback {
    ...
    override fun onCreateView(
        ...
        itemSelection = context?.getSharedPreferences("Situation4", MODE_PRIVATE)
        ...
        for (i in 1..40 step 1) {
            ...
            postItems.add(PostItem(i, 4, item_image))
        }
...
//        }
        ...
        if (itemSelection!!.getInt("cnt", 0) > 0) {
            ...
            for (i in itemListStr) {
                ...
                var postitemdata = PostItemData(userId, imagelist, 4)
                ...
                object : SelectionTracker.SelectionObserver<Long>() {
                    override fun onSelectionChanged() {
                        ...
                        tracker?.let {
                            ...
                            if (actionMode == null) actionMode = (activity as AppCompatActivity?)!!.startSupportActionMode(this@SelectFragment4)
