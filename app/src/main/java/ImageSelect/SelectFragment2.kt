...
class SelectFragment2() : Fragment(), ActionMode.Callback {
                ...
                object : SelectionTracker.SelectionObserver<Long>() {
                    override fun onSelectionChanged() {
                        ...
                        tracker?.let {
                            ...
                            if (actionMode == null) actionMode = (activity as AppCompatActivity?)!!.startSupportActionMode(this@SelectFragment2)
