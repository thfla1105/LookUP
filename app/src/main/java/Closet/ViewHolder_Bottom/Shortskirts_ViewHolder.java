...
public class Shortskirts_ViewHolder extends RecyclerView.ViewHolder {
    int a;
    int mThumbIds;
    TextView textView;
    GridView gridView;
    ...
    String category="shortskirts";

    public Shortskirts_ViewHolder(@NonNull View itemView , int a) { //뷰홀더에서 작업들 실행
        super(itemView);
