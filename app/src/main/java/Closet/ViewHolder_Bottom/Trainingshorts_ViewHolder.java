...
public class Trainingshorts_ViewHolder extends RecyclerView.ViewHolder {
    int a;
    int mThumbIds;
    TextView textView;
    GridView gridView;
    ...
    String category="trainingshorts";

    public Trainingshorts_ViewHolder(@NonNull View itemView , int a) { //뷰홀더에서 작업들 실행
        super(itemView);
        ...
        call.enqueue(new Callback<ImageResponse>() {
            ...
            public void onResponse(Call<ImageResponse> call, Response<ImageResponse> response) {
                ...
                BottomActivity.activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
