...
public class Longsleeve_ViewHolder extends RecyclerView.ViewHolder {
    int a;
    int mThumbIds;
    TextView textView;
    GridView gridView;
    ...
    String category="longsleeve";

    public Longsleeve_ViewHolder(@NonNull View itemView , int a) { //뷰홀더에서 작업들 실행
        super(itemView);
