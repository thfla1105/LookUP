...
public class ToneSelect3 extends AppCompatActivity {

    private TopSelect123 top123;
    private ToneSelect1 toneselect1;
    private ToneSelect2 toneselect2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("top_position3 받아오기전","완료");
        // int position1 = getIntent().getIntExtra("top_position1", -1);
        int position3 = top123.top_position3;

        //int mtone1 = toneselect1.Tone_In_On1;   //여기서 오류 발생,, 3페이지로 넘어가면 튕김
        //int mtone2 = toneselect2.Tone_In_On2;


        Log.d("top_position3 받아옴","완료");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Color.activity.ToneSelect3.this, Color.activity.ToneSelect3.class);
                startActivity(i);
...
//        });
    ...
    private void attemptSendTone123(){
        int tone111 = toneselect1.Tone_In_On1;
        int tone222 = toneselect2.Tone_In_On2;
        int tone333 = Tone_In_On3;
        Log.d("tone112233 :", "완료");

        if (tone111>0 && tone222>0 && tone333>0) {
            sendTone123(new ToneData(tone111, tone222, tone333));

            Log.d("attemptsendtone123 :", "완료");
            showProgress(true);
    ...
    private void sendTone123(ToneData data) {
        service.userCheckTone123(data).enqueue(new Callback<ToneResponse>() {
            @Override
            public void onResponse(Call<ToneResponse> call, Response<ToneResponse> response) {
                ToneResponse result = response.body();
                Toast.makeText(ToneSelect3.this, result.getMessage(), Toast.LENGTH_SHORT).show();
                showProgress(false);
            ...
            public void onFailure(Call<ToneResponse> call, Throwable t) {
                Toast.makeText(ToneSelect3.this, "tone 에러 발생", Toast.LENGTH_SHORT).show();
